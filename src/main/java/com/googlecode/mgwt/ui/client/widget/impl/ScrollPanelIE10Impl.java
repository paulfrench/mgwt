...
public class ScrollPanelIE10Impl extends ScrollPanelImpl {

  private static Logger logger = Logger.getLogger(ScrollPanelIE10Impl.class.getName());
  ...
  private void scrollBar(final DIRECTION direction) {
    ...
    Scheduler.get().scheduleDeferred(new ScheduledCommand() {
      ...
      public void execute() {
        switch (direction) {
          case HORIZONTAL:
            ScrollPanelIE10Impl.this.scrollBarSize[dir] = ScrollPanelIE10Impl.this.scrollBarWrapper[dir].getClientWidth();
            ScrollPanelIE10Impl.this.scrollbarIndicatorSize[dir] =
                (int) Math.max(Math.round((double) (ScrollPanelIE10Impl.this.scrollBarSize[dir] * ScrollPanelIE10Impl.this.scrollBarSize[dir]) / ScrollPanelIE10Impl.this.scrollerWidth), 8);
            ScrollPanelIE10Impl.this.scrollBarIndicator[dir].getStyle().setWidth(ScrollPanelIE10Impl.this.scrollbarIndicatorSize[dir], Unit.PX);

            ScrollPanelIE10Impl.this.scrollbarMaxScroll[dir] = ScrollPanelIE10Impl.this.scrollBarSize[dir] - ScrollPanelIE10Impl.this.scrollbarIndicatorSize[dir];
            ScrollPanelIE10Impl.this.scrollbarProp[dir] = ((double) (ScrollPanelIE10Impl.this.scrollbarMaxScroll[dir])) / ScrollPanelIE10Impl.this.maxScrollX;
            break;
          case VERTICAL:
            ScrollPanelIE10Impl.this.scrollBarSize[dir] = ScrollPanelIE10Impl.this.scrollBarWrapper[dir].getClientHeight();

            ScrollPanelIE10Impl.this.scrollbarIndicatorSize[dir] =
                (int) Math.max(Math.round((double) (ScrollPanelIE10Impl.this.scrollBarSize[dir] * ScrollPanelIE10Impl.this.scrollBarSize[dir]) / ScrollPanelIE10Impl.this.scrollerHeight), 8);
            ScrollPanelIE10Impl.this.scrollBarIndicator[dir].getStyle().setHeight(ScrollPanelIE10Impl.this.scrollbarIndicatorSize[dir], Unit.PX);
            ScrollPanelIE10Impl.this.scrollbarMaxScroll[dir] = ScrollPanelIE10Impl.this.scrollBarSize[dir] - ScrollPanelIE10Impl.this.scrollbarIndicatorSize[dir];
            ScrollPanelIE10Impl.this.scrollbarProp[dir] = ((double) (ScrollPanelIE10Impl.this.scrollbarMaxScroll[dir])) / ScrollPanelIE10Impl.this.maxScrollY;
    ...
    if (wheelActionZoom) {
      ...
      if (Math.abs(deltaScale - this.scale) < 0.00001) {
        ...
        new Timer() {
          ...
          @Override
          public void run() {
            ScrollPanelIE10Impl.this.wheelZoomCount--;
            if (ScrollPanelIE10Impl.this.wheelZoomCount == 0) {
    ...
    final AnimationCallback animationCallback = new AnimationCallback() {
      ...
      public void execute(double now) {
        ...
        if (now >= startTime + step.getTime()) {
          ScrollPanelIE10Impl.this.pos(step.x, step.y);
          ScrollPanelIE10Impl.this.animating = false;
          fireEvent(new ScrollAnimationEndEvent());
          ScrollPanelIE10Impl.this.startAnimation();
          return;
        }
        ...
        ScrollPanelIE10Impl.this.pos(newX, newY);
        fireEvent(new ScrollAnimationMoveEvent());
        if (ScrollPanelIE10Impl.this.animating)
          ScrollPanelIE10Impl.this.aniTime = AnimationScheduler.get().requestAnimationFrame(this);
  ...
  public void refresh() {
    ...
    int[] offSet = offSet(ScrollPanelIE10Impl.this.wrapper.getElement());

    wrapperOffsetLeft = -offSet[0];
    wrapperOffsetTop = -offSet[1];

    // prep stuff
    if (ScrollPanelIE10Impl.this.snapSelector != null) {
      ScrollPanelIE10Impl.this.pagesX = CollectionFactory.constructIntegerArray();
      ScrollPanelIE10Impl.this.pagesY = CollectionFactory.constructIntegerArray();

      ScrollPanelIE10Impl.this.pagesActualX = CollectionFactory.constructIntegerArray();
      ScrollPanelIE10Impl.this.pagesActualY = CollectionFactory.constructIntegerArray();

      JsArray<com.google.gwt.dom.client.Element> elements = querySelectorAll(ScrollPanelIE10Impl.this.scroller.getElement(), snapSelector);

      for (int i = 0; i < elements.length(); i++) {
        int[] pos = offSet(elements.get(i));
        int left = pos[0] + ScrollPanelIE10Impl.this.wrapperOffsetLeft;
        int top = pos[1] + ScrollPanelIE10Impl.this.wrapperOffsetTop;
        ScrollPanelIE10Impl.this.pagesX.push((int) (left < ScrollPanelIE10Impl.this.maxScrollX ? ScrollPanelIE10Impl.this.maxScrollX : left * ScrollPanelIE10Impl.this.scale));
        ScrollPanelIE10Impl.this.pagesY.push((int) (top < ScrollPanelIE10Impl.this.maxScrollY ? ScrollPanelIE10Impl.this.maxScrollY : top * ScrollPanelIE10Impl.this.scale));

        ScrollPanelIE10Impl.this.pagesActualX.push((int) (left * ScrollPanelIE10Impl.this.scale));
        ScrollPanelIE10Impl.this.pagesActualY.push((int) (top * ScrollPanelIE10Impl.this.scale));
      }
    } else {
      if (ScrollPanelIE10Impl.this.snap) {
        int pos = 0;
        int page = 0;
        ScrollPanelIE10Impl.this.pagesX = CollectionFactory.constructIntegerArray();

        while (pos >= ScrollPanelIE10Impl.this.maxScrollX) {
          ScrollPanelIE10Impl.this.pagesX.set(page, pos);
          pos = pos - ScrollPanelIE10Impl.this.wrapperWidth;
          page++;
        }
        if (ScrollPanelIE10Impl.this.maxScrollX % ScrollPanelIE10Impl.this.wrapperWidth != 0)
          ScrollPanelIE10Impl.this.pagesX.set(ScrollPanelIE10Impl.this.pagesX.length(), ScrollPanelIE10Impl.this.maxScrollX
              - ScrollPanelIE10Impl.this.pagesX.get(ScrollPanelIE10Impl.this.pagesX.length() - 1) + ScrollPanelIE10Impl.this.pagesX.get(ScrollPanelIE10Impl.this.pagesX.length() - 1));

        pos = 0;
        page = 0;
        ScrollPanelIE10Impl.this.pagesY = CollectionFactory.constructIntegerArray();
        while (pos >= ScrollPanelIE10Impl.this.maxScrollY) {
          ScrollPanelIE10Impl.this.pagesY.set(page, pos);
          pos = pos - ScrollPanelIE10Impl.this.wrapperHeight;
          page++;
        }
        if (ScrollPanelIE10Impl.this.maxScrollY % ScrollPanelIE10Impl.this.wrapperHeight != 0)
          ScrollPanelIE10Impl.this.pagesY.set(ScrollPanelIE10Impl.this.pagesY.length(), ScrollPanelIE10Impl.this.maxScrollY
              - ScrollPanelIE10Impl.this.pagesY.get(ScrollPanelIE10Impl.this.pagesY.length() - 1) + ScrollPanelIE10Impl.this.pagesY.get(ScrollPanelIE10Impl.this.pagesY.length() - 1));

        ScrollPanelIE10Impl.this.pagesActualX = this.pagesX;
        ScrollPanelIE10Impl.this.pagesActualY = this.pagesY;
      }
    }
    ...
    if (!ScrollPanelIE10Impl.this.zoomed) {
      CssUtil.setTransitionDuration(ScrollPanelIE10Impl.this.scroller.getElement(), 0);
      resetPos(200);
    }
